...
namespace Entity
{
    public class Car
    {
        ...
        public void DrawRoad(Graphics g)
        {
              ...
              //ghash:
              g.DrawLine(p03, new Point(180,430),new Point(170,475));
              g.DrawLine(p03, new Point(150, 420), new Point(168, 480));
              g.DrawLine(p03, new Point(120, 420), new Point(100, 480));
              g.DrawLine(p03, new Point(90, 420), new Point(97, 475));
              g.DrawLine(p03, new Point(190, 440), new Point(160, 455));
              g.DrawLine(p03, new Point(65, 430), new Point(95, 480));
             //new:
              g.FillEllipse(Brushes.Red, 178, 425, 10, 10);// circle 
              g.FillEllipse(Brushes.Pink, 118, 415, 10, 10);//circle 
              g.FillEllipse(Brushes.Yellow, 148, 415, 10, 10);//circle 
              g.FillEllipse(Brushes.Red, 88, 415, 10, 10);// circle 
              g.FillEllipse(Brushes.Yellow, 58, 420, 10, 10);//circle 
              g.FillEllipse(Brushes.Pink, 190, 432, 10, 10);//circle 
            //pata
              g.FillEllipse(Brushes.Green, 170, 470, 10, 10);//circle 
            ...
            //Rode lamp:
              ...
              g.FillEllipse(Brushes.YellowGreen, 100, 15, 20, 20); // red circle
              g.FillEllipse(Brushes.Red, 64, 15, 20, 20); // red circle
            //real 1st treee:-
